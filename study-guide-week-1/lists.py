...
def n_long_words(words, n):
    ...
    for word in words:
        if len(word) > n:
            n_long_words_lst.append(word)

    return n_long_words_lst
...
def smallest_int(numbers):
    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    If the input list is empty, return `None`::
        ...
        True
    """
    sorted_nums_list = sorted(numbers)
    if len(sorted_nums_list) > 0:
        smallest_num = sorted_nums_list[0]
    else:
        smallest_num = None
    return smallest_num
...
def largest_int(numbers):
    ...
    **DO NOT USE** the built-in function `max()`!
    ...
    sorted_nums_list = sorted(numbers)
    if len(sorted_nums_list) > 0:
        largest_num = sorted_nums_list[-1]
    else:
        largest_num = None
    return largest_num
...
def word_lengths(words):
    ...
    lenght_of_words = []
    for word in words:
        lenght_of_words.append(len(word))
